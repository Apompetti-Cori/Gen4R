...
```{r, include = FALSE}
stats <- readRDS(here("results/10/HG002/HG002_stats.rds"))
```
...
```{r, include = FALSE}
stats <- readRDS(here("results/10/HG004/HG004_stats.rds"))
```
...
```{r, include = FALSE}
stats <- readRDS(here("results/10/HG005/HG005_stats.rds"))
```
...
```{r, include = FALSE}
stats <- readRDS(here("results/10/Fibroblast/Fibroblast_stats.rds"))
```
